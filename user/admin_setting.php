  ...
  <main>
    <section>
      ...
      <div id="tm-wrap">
        <div class="container-fluid">
          ...
          <div class="container">
            <center>
              ...
              <br><br>
              <center>
                <form method="post" action="admin_setting?id=<?php echo $id; ?>" enctype="multipart/form-data">
                  <div class="row">
        ...
        <div id="myModal" class="modal" style="display:<?php echo $errmodal2; ?>;">
          <div class="modal-content">
            <center>
              <h1 class="con_us">Wrong Password!</h1>
              <h6 class="cont_des">Access Denied</h6>
              <p>Note: Your ip address is already traced</p>
              <a href="index" class="btn btn-danger btn-lg active" role="button" aria-pressed="true" style="text-transform:uppercase;">Home</a>
            </center>
          </div>
        </div>
        <div id="myModal" class="modal" style="display:<?php echo $errmodal; ?>;">
          <div class="modal-content">
            <center>
              <h1 class="con_us">Password & Confirm Do Not Match!</h1>
              <h6 class="cont_des">Error Change Password Please Try Again</h6>
              <a href="index" class="btn btn-danger btn-lg active" role="button" aria-pressed="true" style="text-transform:uppercase;">Home</a>
            </center>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="txt_oldpass" class="w3-input w3-border w3-round-large" style="width: 90%;" required>
                    </div>
